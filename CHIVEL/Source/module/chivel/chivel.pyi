...
class Image:
    ...
    def draw_rect(self, rect: Tuple[int, int, int, int], color: Optional[Tuple[int, int, int]] = ..., thickness: int = 2) -> None: ...
    def draw_matches(self, matches: List[Tuple[int, int, int, int]], color: Optional[Tuple[int, int, int]] = ..., thickness: int = 2) -> None: ...
    def draw_line(self, start: Tuple[int, int], end: Tuple[int, int], color: Optional[Tuple[int, int, int]] = ..., thickness: int = 2) -> None: ...
    def draw_text(self, text: str, pos: Tuple[int, int], color: Optional[Tuple[int, int, int]] = ..., font_size: int = ...) -> None: ...
    def draw_ellipse(self, center: Tuple[int, int], radius: int | Tuple[int, int], color: Optional[Tuple[int, int, int]] = ..., thickness: int = 2, angle: float = 0) -> None: ...
    def draw_image(self, image: 'Image', pos: Tuple[int, int], alpha: float = 1.0) -> None: ...
    ...
    def edge(self, threshold1: float = ..., threshold2: float = ...) -> None: ...
    def emboss(self) -> None: ...
    def split_channels(self) -> List['Image']: ...
    def merge_channels(self, channels: List['Image']) -> None: ...
    def to_color(self, color_space: int) -> None: ...

def load(path: str) -> Image: ...
def save(image: Image, path: str) -> None: ...
def capture(display_index: int = ..., rect: Tuple[int, int, int, int] = ...) -> Image: ...
def find(source: Image, search: Any, threshold: float = 0.8, text_level: int = ...) -> List[Tuple[int, int, int, int]]: ...
