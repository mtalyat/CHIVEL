...
class Image:
    ...
    def draw_text(self, text: str, pos: Tuple[int, int], color: Optional[Tuple[int, int, int]] = ..., font_size: int = ..., thickness: int = ...) -> None: ...
    ...
    def range(self, lower: Tuple[int, int, int], upper: Tuple[int, int, int]) -> None: ...
